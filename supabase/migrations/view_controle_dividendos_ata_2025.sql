...
--   Regra 50k/48k: pagamento > limite e saldo > limite → competência = limite (50k em jan/26; 48k a partir de fev/26), baixa = min(pagamento-limite, saldo); senão baixa = saldo (zerar).
...
-- Saldo ata mês a mês (recursivo): regra 1.000 e regra limite (50k em jan/26; 48k a partir de fev/26)
rec AS (
